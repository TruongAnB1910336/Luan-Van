    ...
    <main>
        ...
        <div class="row">
            <div class="col-6" style="padding-left: 50px;">
                <h4>NHÀ HÀNG TIỆC CƯỚI CÁT KHÁNH</h4>
                <ul>
                    <li>
                        <b>Trụ sở:</b> 288 Lãnh Binh Thăng, P.11, Q.11, TP.HCM
                    </li>
                    <li>
                        <b>Điện thoại:</b> (028) 3962.3238
                    </li>
                    <li>
                        <b>Di động:</b> 0902.816.288
                    </li>
                    <li>
                        <b>Email:</b> tieccuoicatkhanh@yahoo.com.vn
                    </li>
                    <li>
                        <b>Website:</b>tieccuoicatkhanh.vn
                    </li>
                </ul>
                <p>
                    Mọi ý kiến phản hồi, góp ý về dịch vụ, sản phẩm, đặt hàng, 
                    hợp tác kinh doanh vui lòng liên hệ tại đây chúng tôi sẽ phản hồi trong thời gian sớm nhất.
                </p>
                <p>
                    Hoặc liên hệ số hotline: 0902.816.288
                </p>
                <p>
                    Rất mong cơ hội  hợp tác cùng quý khách hàng. Trân trọng!
                </p>
            </div>

            <div class="col-6">
                <p>
                    Mọi thắc mắc, quý khách vui lòng điền đầy đủ thông tin vào Form bên dưới:
                </p>
                <form action="#" method="post">
                    Họ tên (*)<br>
                    <input type="text" size="70" style="background-color: blanchedalmond;border: 1px solid;">  <br>
                    Điện thoại (*) <br>
                    <input type="text" size="70" style="background-color: blanchedalmond;border: 1px solid;"> <br>
                    Địa chỉ email (*) <br>
                    <input type="text" size="70" style="background-color: blanchedalmond;border: 1px solid;"> <br>
                    Nội dung  <br>
                    <textarea rows="6" cols="73" style="background-color: blanchedalmond;border: 1px solid;">

                    </textarea>  <br>
                    <button class="btn btn-success">Gửi đi</button>
                </form>
            </div>
        </div>

        <h5 style="margin-left: 30px;color: darkgreen;margin-bottom: 30px;">BẢN ĐỒ CHỈ DẨN</h5>
